...
class Model_4(Model_Base):
	...
	def forward(self, input_tensor: torch.Tensor) -> Any:
		...
		# the first time slice is the channel image of T=0
		#
		# as it is in training stage, the channel image of T=0 is valid
		#
		# separate channel image at T=0 and rest of the channel image
		x = input_tensor[:, 1:, :, :, :]
